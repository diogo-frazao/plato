...
static const char* s_allLayersAsString = { "BEHIND_CHAR_LAYER\0BACK_LIGHTS_LAYER\0CHARACTER_LAYER\0IN_FRONT_CHAR_LAYER\0FRONT_LIGHTS_LAYER\0LEVEL_GEOMETRY_LAYER\0CELLPHONE_LAYER\0CROSSHAIR_LAYER\0" };
