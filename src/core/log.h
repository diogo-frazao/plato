...
{
    static const char* k_textColorTable[TEXT_COLOR_COUNT] =
    {
    ...
    const char* debugTypePrefix;
    TextColor textColor;

    switch (logType)
    {
        case MINI:
            debugTypePrefix = "MINI:";
        ...
        case LOG:
            ...
            break;
        case WARNING:
            debugTypePrefix = "WARNING:";
            textColor = TEXT_COLOR_YELLOW;
            break;
        case ERROR:
            debugTypePrefix = "ERROR";
    ...
    sprintf_s(formatBuffer, sizeof(formatBuffer), "%s %s %s \033[0m", k_textColorTable[textColor], debugTypePrefix, msg);
